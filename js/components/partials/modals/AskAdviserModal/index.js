...
import { ROOT_URL, CREATE_INQUIRE_ENDPOINT } from './../../../../constants/endpoint';
import CompleteMessageUser from "../../CompleteMessageUser";

export default class AskAdviserModal extends Component {
    ...
    handleSubmit = () => {
        if (!this.isFetching) {
            ...
            axios.post(ROOT_URL + CREATE_INQUIRE_ENDPOINT, postData)
            .then(json => {
    ...
    render() {
        return (
            <div className="modal fade modal-processbar" id="AskAdviserModal" data-backdrop="static" data-keyboard="false" tabIndex="-1" aria-labelledby="modelAskAdviserLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-lg">
                    <div className="modal-content">
                    <div className="modal-header text-center">
                        <h5 className="modal-title w-100" id="modelAskAdviserLabel"><b>{ trans('main.SCN_REQUEST_SELECTION')}</b></h5>
                                    ...
                                    <fieldset>
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <p className="id-adviser"><b>[顧問情報]  ID: {this.props.modal.data.adviser?.komon_id || ''}　{this.props.modal.data.adviser?.company_name || ''}　{this.props.modal.data.adviser?.position || ''}</b></p>
                                            </div>
                                        </div>
                                        <div className="form-group row">
...
● 事前に確認しておきたいこと" />
                                    ...
                                    <fieldset>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input className="form-control input-confirm" id="id-adviser-mission" value={this.props.modal.data.topic_name || ''} name="topic_name" disabled />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <textarea className="form-control textarea-content-confirm" value={this.props.modal.data.description || ''} name="description" rows="15" disabled />
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-sm-3">&nbsp;</div>
