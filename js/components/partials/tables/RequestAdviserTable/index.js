...
import { USER_DETAIL_REQUEST_ADVISER_PATH } from './../../../../constants/path';

export default function RequestAdviserTable(props) {
    return (
            ...
            <table className="table table-bordered table-striped datatable">
                <thead>
                    <tr>
                        ...
                        <THSort name="topic_name" {...props.sort}>{ trans('main.INFO_LBL_TOPIC') }</THSort>
                        ...
                        <tr key={item.id}>
                            ...
                            <td className="text-center" width="5%">
                                <Link
                                    ...
                                    to={generatePath(getPath(USER_DETAIL_REQUEST_ADVISER_PATH), {id: item.id})}>
