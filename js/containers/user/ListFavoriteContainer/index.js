...
import { USER_FAVORITES_PATH } from './../../../constants/path';
import { ROOT_URL, USER_FAVORITES_ENDPOINT } from './../../../constants/endpoint';
...
const URL_SEARCH = ROOT_URL + USER_FAVORITES_ENDPOINT;
    ...
    reloadData = (url, params = {}) => {
        if (!this.isFetching) {
            ...
            .then(json => {
                $('#loading').hide();
                browserHistory.push({
                    pathname: getPath(USER_FAVORITES_PATH),
...
export default connect(mapStateToProps, mapDispatchToProps)(ListFavoriteContainer);